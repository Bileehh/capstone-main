            ...
            <div class="showcase">
                <div class="type showcase_job">
                    <a href="./?a=join&step=2&type=2">
                        <img src="../assets/employer.png" alt="team">
                        <p>COMPANY</p>
                    </a>
                </div>
                <h3 class="divider">
                ...
                <div class="type showcase_company">
                    <a href="./?a=join&step=2&type=3">
                        <img src="../assets/jobseeker.png" alt="company">
                        <p>Jobseeker</p>
                    </a>
                </div>  
            </div>
            <p >Already on AccessiblePath? <a href="./?a=already">Sign in</a></p>
        </div>
        </div>
    <?php
        ...
        <div class="main" id="main_login">
            ...
            <div class="body">
                ...
                <form method="post" class="form login_account">
                    ...
                    <p class="already">New to AccessiblePath? <a href="./?a=join">Join Now</a></p>
                </form>
            </div>
           ...
           <div class="modal-content">
             <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <p class="terms"><span class="company_name">AccessiblePath</span> <b>User Agreement and Privacy Policy.</b>  </p>
             </div>
             <div class="modal-body">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Elit duis tristique sollicitudin nibh.</p>
                 <p>The administrator shall not be responsible to anyone who posts or accesses information or otherwise uses AccessiblePath.com 
                ...
                <p>By using the AccessiblePath service as a student or prospective employer, you agree to defend, 
                ...
                <p>When using AccessiblePath, your personal information will not be released by the admin staff to an employer 
                ...
                <p>By activating your AccessiblePath account to post or retrieve information or to engage in 
